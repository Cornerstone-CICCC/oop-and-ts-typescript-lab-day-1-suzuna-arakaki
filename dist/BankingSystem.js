...
function processTransaction(accountNo, amount, type) {
    var foundAccount = accounts.find(function (account) { return account.accountNo === accountNo; });
    if (!foundAccount) {
    ...
    return type === TransactionType.Deposit
        ? "".concat(amount, " deposited into account number ").concat(accountNo)
        : "".concat(amount, " withdrawn from account number ").concat(accountNo);
}
